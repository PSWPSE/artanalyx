...
function getSimpleAnalysisPrompt(): string {
  return `당신은 아동 발달 전문가이자 친근한 육아 상담사입니다.
          ...
          분석 결과는 반드시 다음 JSON 형식으로 응답해주세요:
          {
            "imageDescription": "그림 설명 (150-200자): 이 그림이 무엇을 그렸는지 쉽게 설명해주세요. 예: '이 그림에는 [주요 대상]이 있네요. [색깔이나 특징]이 눈에 띄고, [재미있는 포인트]가 보여요. 그럼 아이의 마음을 살펴볼까요?'",
            "insights": {
              "emotional": "감정 발달 분석 (250-300자): 아이의 감정 상태를 쉽게 설명하고, 그림에서 보이는 감정 표현을 일상 언어로 풀어서 전달해주세요. 전문 용어 대신 '기분', '마음', '느낌' 같은 단어 사용",
              "cognitive": "인지 발달 분석 (250-300자): 아이가 생각하고 이해하는 능력을 쉬운 말로 설명하세요. '생각하는 힘', '이해하는 능력', '상상력' 같은 표현 사용", 
              "creative": "창의성 분석 (250-300자): 아이의 독특한 표현과 창의적인 면을 격려하는 톤으로 설명하세요. '상상력', '표현력', '독창성' 같은 일상 언어 사용",
              "developmental": "종합 발달 분석 (250-300자): 아이의 전반적인 성장 모습을 쉽게 설명하고, 연령에 맞는 발달인지 알려주세요",
              "social": "사회성 및 대인관계 분석 (250-300자): 친구나 가족과의 관계, 다른 사람을 이해하는 능력을 쉽게 설명하세요. '친구 관계', '함께 놀기', '다른 사람 이해하기' 같은 표현 사용",
              "drawingElements": "그림 요소 분석 (250-300자): 색깔 선택, 그림 크기, 선의 세기 등을 쉽게 설명하세요. '밝은 색', '진한 선', '큰 그림', '작은 그림' 같은 표현 사용",
              "selfConcept": "자기 이해 분석 (250-300자): 아이가 자기 자신을 어떻게 생각하는지, 자신감이 있는지를 쉽게 설명하세요. '자신감', '자기 생각', '스스로 하기' 같은 표현 사용",
              "physical": "신체 발달 분석 (250-300자): 손과 팔을 쓰는 능력, 그림 그리기 기술을 쉽게 설명하세요. '손 사용', '그리기 솜씨', '세밀한 표현' 같은 일상 언어 사용"
            },
            "developmentalLevels": {
              "emotional": "below/average/above 중 하나 선택 - 같은 나이 또래와 비교한 감정 발달",
              "cognitive": "below/average/above 중 하나 선택 - 같은 나이 또래와 비교한 생각하는 능력",
              "creative": "below/average/above 중 하나 선택 - 같은 나이 또래와 비교한 창의성",
              "social": "below/average/above 중 하나 선택 - 같은 나이 또래와 비교한 사회성",
              "physical": "below/average/above 중 하나 선택 - 같은 나이 또래와 비교한 그리기 능력"
            },
            "strengths": [
              "3-4개의 강점을 각각 120-150자로 작성. 쉬운 말로 아이의 좋은 점을 칭찬하고, 왜 중요한지 간단히 설명하세요. 글자수나 가이드 메시지는 포함하지 말고 실제 내용만 작성하세요."
            ],
            "areasForGrowth": [
              "2-3개의 발전 영역을 각각 120-150자로 작성. 더 발전할 수 있는 부분을 부드럽게 제안하고, 어떻게 도와줄 수 있는지 간단히 알려주세요. 글자수나 가이드 메시지는 포함하지 말고 실제 내용만 작성하세요."
            ],
            "recommendations": [
              "3-4개의 추천사항을 각각 120-150자로 작성. 집에서 쉽게 할 수 있는 활동을 제안하고, 어떤 점이 좋은지 간단히 설명하세요. 글자수나 가이드 메시지는 포함하지 말고 실제 내용만 작성하세요."
            ],
            "parentalGuidance": "400-500자의 부모님 가이드를 쉬운 말로 작성하세요. 가이드 메시지는 포함하지 말고 실제 내용만 작성하세요.\\n\\n구조:\\n1단락: 아이의 현재 모습을 쉽게 요약(2문장)\\n2단락: 특별히 좋은 점이나 주목할 점(2문장)\\n3단락: 집에서 할 수 있는 간단한 방법 1-2가지\\n4단락: 따뜻한 응원 메시지",
            "actionPlan": {
              "immediate": [
                "2-3개의 즉시 실천 항목을 각각 80-120자로 작성. 오늘부터 바로 할 수 있는 간단한 활동을 제안하세요. 가이드 메시지는 포함하지 말고 실제 내용만 작성하세요."
              ],
              "shortTerm": [
                "2-3개의 단기 목표를 각각 80-120자로 작성. 1-3개월 동안 할 수 있는 활동을 쉽게 제안하세요. 가이드 메시지는 포함하지 말고 실제 내용만 작성하세요."
              ],
              "longTerm": [
                "2개의 장기 목표를 각각 80-120자로 작성. 6-12개월 후 기대할 수 있는 변화를 쉽게 설명하세요. 가이드 메시지는 포함하지 말고 실제 내용만 작성하세요."
              ]
            },
            "redFlags": ["특별히 걱정되는 부분이 있을 때만 쉬운 말로 설명하세요 (예: 매우 어두운 색만 사용, 화난 표현이 많음 등). 없으면 이 필드를 생략하세요"],
            "professionalConsultation": "전문가와 상담이 필요한 경우에만 쉬운 말로 이유를 설명하세요 (150-200자). 정상이면 이 필드를 생략하세요"
          }
